...
This paper gives an overview of the semantics
of the small language of \rsevenrs.
The purpose of this overview is to explain
enough about the basic concepts of the language to facilitate
understanding of the \rsevenrs{} report, which are
...
and going from inside to outside, and referring to a outermost
binding if no
...
expression types, but are comparatively rare.)
...
is not needed for representations of numbers or booleans.
...
A Schemeprogram is invoked via a \textit{ program}.  Like a library, a top-level
