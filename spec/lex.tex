...
If they do so, they must support the following optional directives
...
tokens.
The {\cf{}\#!fold-case} directive causes the reader to case-fold
...
The scope of these directives is all subsequent {\cf read} operations
for the port from which they are read, until another such directive
is encountered.  No other ports are affected.
\end{entry}
