...
languages, which involve converting all arguments to inexact numbers if any argument is inexact, are not transitive.
\end{note}
...
\rproto{read-bytevector!}{ bytevector start}{procedure}
\rproto{read-bytevector!}{ bytevector start end}{procedure}
