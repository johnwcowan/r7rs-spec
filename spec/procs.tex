...
The \var{list} argument may be circular, but
...
{\tt \#\backwhack{}iota}&; $\iota$ (if both character and name are supported)\\
\end{tabular}
$$
...
It is an error if \var{end} is greater than the length of \var{vector}.
...
However, like the {\cf raise} and {\cf error} procedures, it does not
