...
Parameter objects are implemented here as procedures, and use two
hidden objects \texttt{<param-set!>} and \texttt{<param-convert>} to
coordinate with {\cf parameterize}:
