...
{\cf eqv?}.  It must always return \schfalse{} when {\cf eq?}\ also
would, but may return \schfalse{} in some cases where {\cf eq?}\ would return \schtrue{}.

\vest On symbols, booleans, the empty list, pairs, records,
non-empty
