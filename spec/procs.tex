...
so bindings must be introduced with {\cf import}.
...
\vest Implementations that provide more than one representation
of floating-point numbers with differing precisions
must follow these rules: An inexact result
...
(as by {\cf sqrt}), then
the most precise representation available must be used.
...
exponent or if it contains a ``\sharpsign'' character in the place of a digit.
...
that don't support the complex module.
...
values that may be useful rather than just \schtrue{} or \schfalse{}.
\end{rationale}
\end{entry}
...
\begin{entry}{%
\proto{char-ci=?}{ \vri{char} \vrii{char} \vriii{char} \dotsfoo}{char module procedure}
\proto{char-ci<?}{ \vri{char} \vrii{char} \vriii{char} \dotsfoo}{char module procedure}
\proto{char-ci>?}{ \vri{char} \vrii{char} \vriii{char} \dotsfoo}{char module procedure}
\proto{char-ci<=?}{ \vri{char} \vrii{char} \vriii{char} \dotsfoo}{char module procedure}
\proto{char-ci>=?}{ \vri{char} \vrii{char} \vriii{char} \dotsfoo}{char module procedure}}
...
\begin{entry}{%
\proto{char-alphabetic?}{ char}{char module procedure}
\proto{char-numeric?}{ char}{char module procedure}
\proto{char-whitespace?}{ char}{char module procedure}
\proto{char-upper-case?}{ letter}{char module procedure}
\proto{char-lower-case?}{ letter}{char module procedure}}
...
\begin{entry}{%
\proto{char-upcase}{ char}{char module procedure}
\proto{char-downcase}{ char}{char module procedure}
\proto{char-foldcase}{ char}{char module procedure}}
...
{\cf string}, {\cf string-set!}, or {\cf string-fill}.
...
\begin{entry}{%
\proto{string-ci=?}{ \vri{char} \vrii{char} \vriii{char} \dotsfoo}{char module procedure}}
...
\proto{string-ci<?}{ \vri{string} \vrii{string} \vriii{string} \dotsfoo}{char module procedure}
\proto{string-ni<?}{ \vri{string} \vrii{string} \vriii{string} \dotsfoo}{char module procedure}
\proto{string>?}{ \vri{string} \vrii{string} \vriii{string} \dotsfoo}{procedure}
\proto{string-ci>?}{ \vri{string} \vrii{string} \vriii{string} \dotsfoo}{char module procedure}
\proto{string-ni>?}{ \vri{string} \vrii{string} \vriii{string} \dotsfoo}{char module procedure}
\proto{string<=?}{ \vri{string} \vrii{string} \vriii{string} \dotsfoo}{procedure}
...
\begin{entry}{%
\proto{string-upcase}{ string}{char module procedure}
\proto{string-downcase}{ string}{char module procedure}
\proto{string-foldcase}{ string}{char module procedure}}
...
in the elements of \var{vector}, which must be characters allowed in a string.
...
Copies the bytes of bytevector \var{from} to bytevector \var{to}, which must not be
...
must be true.  The value returned by {\cf bytevector-copy-partial!} is unspecified.
\end{entry}
...
which is a procedure which accepts zero arguments and
returns its associated value.  Initially, this value is the value of
...
using {\cf parameterize}, which is described in
section~\ref{dynamicbindingssection}.
...
defined either in the {\cf base} module or in the other modules
...
\begin{entry}{%
\proto{environment}{ \vri{list} \dotsfoo}{eval module procedure}}
...
are bound to system defined character ports.
...
and {\cf close-output-port} procedures may be used to close the
...
\begin{entry}{%
\proto{read-line}{}{io module procedure}
\rproto{read-line}{ port}{io module procedure}}
