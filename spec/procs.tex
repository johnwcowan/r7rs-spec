...
supports Unicode should use either Unicode normalization NFC or
...
\var{proc}.
\domain{It is an error if \var{proc} does not accept one
argument.}
...
\var{thunk} does not accept zero arguments.}
