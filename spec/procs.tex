...
Conceptually, bytevectors can be thought of as homogeneous vectors of 8-bit
...
Forces the value of \var{promise} (see \ide{delay} and \ide{lazy},
...
\begin{scheme}
(lazy (make-promise \schtrue{} \hyper{expression}))%
\end{scheme}
...
Finally, we define {\cf force} to iteratively call the procedure
expressions in promises using a trampoline technique until a non-lazy
...
as well as any \var{obj}s, known as the irritants.
...
variable and the cdr is its value.  The order of the list is unspecified.
