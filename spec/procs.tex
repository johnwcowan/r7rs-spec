...
the Unicode properties Alphabetic, Numeric, White_Space, Uppercase, and
...
implementation.  Note that Turkic casing pairs are ignored.  If the
...
Turkic-specific folding is ignored.  If the argument is an uppercase
