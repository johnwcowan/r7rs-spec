...
It is an error if \var{expression} is not a valid Scheme expression represented as a datum.
...
If \var{version} is equal to {\cf \integerversion},
...
It is an error if \var{proc} does not accept one argument.  The {\cf call-with-port}
