...
The list of character names which must be supported
by all implementations is given in section~\ref{charactersyntax}.
...
{\cf (converter \var{init})}.
(If the conversion procedure \var{converter} is not specified the identity
function is used instead.)
However, the associated value may be temporarily changed
using {\cf parameterize}.
