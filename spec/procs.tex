...
described in that standard, but are not both representations of NaNs.

\item \vari{obj} and \varii{obj} are both inexact real numbers,
do not conform to IEEE 754-2008, and are numerically equal (see {\cf =}),
but are not both representations of NaNs.

\item \vari{obj} and \varii{obj} are both complex numbers whose
real and imaginary parts are {\cf eqv?}, respectively.
...
\item \vari{obj} and \varii{obj} are both complex numbers whose
real or imaginary parts are not {\cf eqv?}, respectively.
...
In particular, an \defining{exact complex number} must have an exact real part
...
\domain{It is an error if \var{start} is greater than \var{end}, or \var{start} is less than zero, or \var{end} is greater than the length of \var{string}.}
...
\domain{It is an error if \var{fill} is not a character or is forbidden
in strings.  It is also an error if \var{start} is greater than \var{end}, or \var{start}
is less than zero, or \var{end} is greater than or equal to the length
of \var{string}.}
...
\domain{It is an error if any element is not a character, or is a character forbidden in strings.}
...
\domain{It is an error if \var{start} is greater than \var{end}, or \var{start} is less than zero, or \var{end} is greater than the length of \var{vector}.}
...
\domain{It is an error if \var{start} is greater than \var{end}, or \var{start}
is less than zero, or \var{end} is greater than or equal to the length
of \var{vector}.}
