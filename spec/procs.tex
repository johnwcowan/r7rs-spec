...
Returns the square of \vr{z}.  Taking the square of a large integer
is more efficient than multiplying arbitrary integers,
and floating-point processors often have a primitive square operator.
...
It is an error if \var{start} is less than \var{end}.
...
or if \var{start} is less than \var{end}.
...
or \var{to} is less than zero or greater than the length of \var{to}.
...
are escaped either with inline hex escapes or with vertical lines.
