...
Returns a newly allocated bytevector of \var{k} bytes.  The initial contents
...
Returns the \var{k}th byte of \var{bytevector} as an exact integer in the
range $[0..255]$.
\end{entry}

\begin{entry}{%
\proto{bytevector-u8-set!}{ bytevector k u8}{procedure}}

Stores \var{u8} as the \var{k}th byte of \var{bytevector}.  \var{u8} must be
