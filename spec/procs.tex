...
In all other cases, {\cf equal?} may return either \schtrue{} or \schfalse{}.
...
already exists.
If the
file cannot be opened, an error is signalled satisfying {\cf file-error?}.  If \var{proc} returns,
...
an error is signalled satisfying {\cf file-error?} if the file named by \var{string} does not already exist; for
