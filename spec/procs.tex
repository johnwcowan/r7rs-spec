...
an error that satisfies {\cf file-error?} is signaled if
the file named by \var{string} does not already exist; for
{\cf call-with-output-file},
the effect is unspecified if the file
already exists.
If the
file cannot be opened, an error that satisfies {\cf file-error?} is signaled.  If \var{proc} returns,
...
an error that satisfies {\cf file-error?} is signaled if the file named by \var{string} does not already exist; for
...
file.  If the file cannot be opened, an error that satisfies {\cf file-error?} is signaled.
