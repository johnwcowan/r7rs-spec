...
in the following ways.  Whenever \vr{string} contains an explicit radix prefix,
...
If \var{start} and \var{end} are given, {\cf string-fill!} stores \var{fill}
in all the elements of \var{string}
...
If \var{start} and \var{end}y are omitted, \var{fill} is stored in all the elements of \var{string}.
...
If \var{start} and \var{end} are given, {\cf vector-fill!} stores \var{fill}
(which can be any object) in all the elements of \var{vector}
between \var{start} (inclusive) and \var{end} (exclusive).
It is an error if \var{start} is less than \var{end}.
If they are omitted, \var{fill} is stored in all the elements of \var{vector}.
...
Procedures in this section that invoke procedural arguments
