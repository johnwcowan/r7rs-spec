...
and returning a single value.  If more
than one \var{string} is given, then they must all be the same length.}
...
and returning a single value.  If more
than one \var{vector} is given, then they must all be the same length.}
