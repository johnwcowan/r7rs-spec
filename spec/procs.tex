...
If it is a generalized definition, the specified identifier(s) are defined in the specified
...
expressions and generalized definitions from the file and evaluates them
