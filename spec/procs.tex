...
\label{continuations} \domain{It is an error unless {\var{proc} is a procedure of one
...
\domain{It is an error unless \var{handler} is a procedure and accepts one argument,
...
It is an error unless \var{proc} is a procedure that accepts one argument.
\todo{consider removing unspecified effect}
