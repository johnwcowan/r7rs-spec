...
However, with the exception of {\tt \#\backwhack{}null}, ASCII characters may
not be forbidden.
For example, an implementation might support the entire Unicode repertoire,
but only allow characters U+0001 to U+00FF (the Latin-1 repertoire) in
...
\domain{It is an error if any element is a character forbidden in strings.}
