...
{\cf(scheme base)} library.  This library includes mostly core syntax
...
\begin{entry}{%
\proto{numeric-digit}{ char}{char library procedure}}
...
\var{obj}.  It is similar to {\cf lazy}, but does not delay
...
\proto{load}{ filename environment-specifier}{load library procedure}}
