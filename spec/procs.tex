...
languages, which involve converting all arguments to inexact numbers
if any argument is inexact, are not transitive.  For example, let
...
{\cf (= (inexact big) (+ big 1))} would both be true in a traditional
implementation of {\cf =}, because of the limitations of IEEE
