...
\begin{entry}{%
\proto{string-ci=?}{ \vri{char} \vrii{char} \vriii{char} \dotsfoo}{procedure}}
...
\proto{string-ci<?}{ \vri{string} \vrii{string} \vriii{string} \dotsfoo}{procedure}
...
to have the same meaning as the following {\cf lazy} form:
...
Returns \schtrue{} if \var{obj} is an object created by {\cf error}, otherwise returns
\schfalse.  
...
\defining{environment} consisting of \definining{environment variables}.
