...
Returns a newly allocated vectors whose elements are the concatenation
...
an error is signalled if the file named by \var{string} does not already exist; for
