...
Another restriction is that the continuation of no \hyper{init}
should be invoked more than once.
...
\hyper{body} should be a sequence of one or more definitions followed
