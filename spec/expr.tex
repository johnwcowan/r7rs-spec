...
not intended to illustrate good programming style, 
as {\cf delay}, {\cf lazy}, and {\cf force} are mainly intended for
...
specified parameter objects for its dynamic extent of the body.
