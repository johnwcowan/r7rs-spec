...
\item It may appear as part of a \hyper{body}, or at the
  ...
  the shape specified in the first header line. This use of begin acts
...
The \var{param} expressions and \texttt{(\var{converter} \var{value})}
...
\texttt{(\var{converter} \var{value})}.  The results of the last
\hyper{expr} are returned as the results of the entire {\cf
  parameterize}.
