...
\syntax
\hyper{Test}, \hyper{consequent}, and \hyper{alternate} should be
expressions.
...
This form may appear as part of a \hyper{body}, or at the
\hyper{top-level}, or directly nested in a {\cf begin} of this form.
It causes the contained expressions and definitionss to be evaluated
...
This form can be used as an ordinary expression.
...
The {\cf force} procedure
forces the value of a \var{promise} created by \ide{delay} or \ide{lazy}.\index{promise}
...
The {\cf eager} procedure returns a promise which when forced will return
...
\subsection{Datum labels}\unsection
\label{labelsection}
...
\subsection{Signalling errors in macro transformers}
\label{syntax-error}
