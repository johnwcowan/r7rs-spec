...
The {\cf lazy} construct is similar to {\cf delay}, but it is an error
for its argument not to evaluate to a promise.
...
by \ide{delay} or \ide{lazy}.\index{promise}
...
style, as {\cf delay}, {\cf lazy}, and {\cf force} are mainly intended
...
\item $P$ is a constant and $F$ is equal to $P$ in the sense of
