...
The associated value may be temporarily changed
...
\domain{The value of each \hyper{param} expression must be a parameter object.}
...
circular references except in literal expressions.  In particular,
