...
\item An exception system

\item User-defined record types

\item Binary I/O

\item Binary data structures (blobs)

\item Syntax-rules extensions

\item System interfaces to the environment, the command line, and current time

\item Infinities and NaNs

\item Additional reader syntax for comments and data with shared structure

\item Explicit control of case-folding, with no folding as the default
