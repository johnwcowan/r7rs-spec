...
{\cf unquote-splicing}                 {\cf values}
{\cf vector}          {\cf vector->list}    {\cf vector->string}
{\cf vector-copy}     {\cf vector-copy!}    {\cf vector-fill!}
{\cf vector-for-each} {\cf vector-length}   {\cf vector-map}
{\cf vector-ref}      {\cf vector-set!}     {\cf vector?}
{\cf when}            {\cf with-exception-handler}
{\cf zero?}
peek-char
{\cf peek-u8}         {\cf port?\ }          {\cf read-bytevector}
{\cf read-bytevector!}                 {\cf read-char}
{\cf read-line}       {\cf read-u8}         {\cf string->utf8}
{\cf u8-ready?\ }      {\cf utf8->string}
