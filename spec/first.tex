...
\multicolumn{3}{c}{\textit{(Editors, Revised$^5$ Report on the Algorithmic Language Scheme)}} \\
\\
...
\multicolumn{3}{c}{\textit{(Editors, Revised$^6$ Report on the Algorithmic Language Scheme)}} \\
\end{tabular}
$$
%% \vskip 2ex
