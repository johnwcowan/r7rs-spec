...
\\
\multicolumn{2}{c}{R\authorsc{ICHARD} K\authorsc{ELSEY},
W\authorsc{ILLIAM} C\authorsc{LINGER},
\authorsc{AND} J\authorsc{ONATHAN} R\authorsc{EES}} \\
\multicolumn{2}{c}{\textit{(Editors, Revised$^5$ Report on the Algorithmic Language Scheme)}} \\
\\
\multicolumn{2}{c}{M\authorsc{ICHAEL} S\authorsc{PERBER},
...
\multicolumn{2}{c}{\textit{(Editors, Revised$^6$ Report on the Algorithmic Language Scheme)}} \\
\end{tabular}
$$
%% \vskip 2ex
