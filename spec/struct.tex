...
Algol 60, C, C++, C#, Haskell, Java, ML, and Pascal.
...
extent include 
APL, C#, Common Lisp, Haskell, Java, JavaScript, ML, Perl,
...
APL, C#, Common Lisp, Java, JavaScript, ML, Pascal,
Python, Ruby, and Smalltalk.
