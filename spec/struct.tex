...
\defining{modules}.  Identifiers defined in the {\cf base} module
...
a specific \defining{module}.  A summary of all the standard modules
and feature they provide is given in \ref{stdmodules}.
...
the procedure {\cf raise}.  The object raised is implementation-dependent
and need not be a fresh object every time.
...
\noindent\pproto{\var{template}}{\var{module} \var{category}}\unpenalty

where \var{module} is the short name of a module
as defined in Appendix~\ref{stdmodules}.
...
syntax binding that may occur only as part of specific surrounding
