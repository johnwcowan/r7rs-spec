...
\>  \| \meta{label} \= \meta{token} \| \meta{label} \#
...
\meta{symbol element} \: \meta{any character other than \meta{vertical bar} or \backwhack}
...
\meta{complex $R$} \: %
   ...
   \> \| + \meta{ureal $R$} i %
      ...
      \| + i %
      \| - i
\meta{real $R$} \: \meta{sign} \meta{ureal $R$} \| \meta{infinity} %
\meta{ureal $R$} \: %
         \meta{uinteger $R$}
