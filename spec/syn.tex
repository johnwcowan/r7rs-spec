...
\meta{whitespace} \: \meta{intraline whitespace or newline or return}
...
\meta{expression keyword} \: quote \| lambda \| if
 ...
 \>  \| let \| let* \| letrec \| letrec* \| delay \| lazy
 \>  \| let-values \| let*-values \| do \| case-lambda
 \>  \| guard \| parameterize \| quasiquote
...
\>  \| (and \arbno{\meta{test}})
\>  \| (or \arbno{\meta{test}})
\>  \| (when \meta{expression} \meta{body})
\>  \| (unless \meta{expression} \meta{body})
...
\>  \| (letrec* (\arbno{\meta{binding spec}}) \meta{body})
\>  \| (let-values (\arbno{\meta{formals}}) \meta{body})
\>  \| (let*-values (\arbno{\meta{formals}}) \meta{body})
