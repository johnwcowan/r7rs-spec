...
(define-library (example grid)
  ...
  (begin
    ...
    ;; Return \schfalse{}alse if out of range.
    (define (ref grid n m)
      (and (< -1 n (rows grid))
           (< -1 m (cols grid))
...
(grid-set! grid 1 1 \schtrue{}rue)
(grid-set! grid 2 2 \schtrue{}rue)
(grid-set! grid 3 0 \schtrue{}rue)
(grid-set! grid 3 1 \schtrue{}rue)
(grid-set! grid 3 2 \schtrue{}rue)
