...
\todo{JC: Removed this in favor of allowing set! to bind
an unbound variable, which does not conflict with saying the top-level
environment of a program or library is empty of bindings.}
