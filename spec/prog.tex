...
literally, analagous to the top-level \ide{begin}.  \ide{include} and
...
select expand different module declarations depending on the platform
or implementation under which the module is being resolved.  A
...
on the implementation's list with \schtrue, and all other feature
