...
at least one import declaration followed by a sequence of
expressions, definitions, syntax definitions, and
...
the other parts of a program, as well as libraries, are the subject of the
...
The other parts of a program can be interpreted declaratively.
They cause bindings to be created in the top level
environment or modify the value of existing top-level bindings.
The initial environment of a Scheme program is empty,
...
equivalent to the sequence of expressions, definitions, syntax definitions,
and record type definitions
