...
\todo{Shinn: If not in this report, then in a ``standard practice''
  ...
  structure and file extensions used for libraries and programs.}
...
\item {\tt(define-library \hyper{library name})}
...
each \hyper{feature identifier} and {\tt(define-library \hyper{library name})}
