...
must not be not empty, but must start out with variables
...
It is an error for identifiers in library names to contain any of the characters
{\cf | \backwhack{} ? * < " : > + [ ] /} or control characters
after escapes are expanded.
...
the library.  The \ide{begin} declaration takes a list of expressions and definitions to be spliced
