...
such a body is not apparent until after expansion of other syntax.
...
of any top-level binding for \hyper{keyword} remain unchanged.
...
Like other definitions, they may appear either at top level or in a \ide{body}.
