...
{\em eof-object}, and the empty list
object.
...
Since \ide{eqv?} is not defined on procedures,
this means that a procedure fetched from one of these locations
may not be {\cf eqv?} to the procedure stored, though it is guaranteed
