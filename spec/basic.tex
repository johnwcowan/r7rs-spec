...
(which is unique), empty strings, empty vectors, and empty bytevectors
that an empty list is newly allocated (there is only one empty-list object).
It is also understood that the phrases "newly allocated string", "newly
allocated vector", and "newly allocated bytevector"
